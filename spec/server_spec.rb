...
module HAProxyManager
  describe Server do
    ...
    it 'should return UP when no backend is specified' do
      @server.status.should eq('UP')
    end
    ...
    it 'should return true when up when no backend is provided' do
      @server.up?.should be_true
    end
    it 'should return true when up when a backend is provided' do
      @server.up?('foo-farm').should be_true
    end
    it 'should return false when down and no backend is provided' do
      @server.down?.should be_false
    end
